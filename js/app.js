...
function mostrarAutos(autos) {
    ...
    autos.forEach( auto => {
        ...
        autoHTML.textContent = `
          ${auto.marca} ${auto.modelo} - ${year} - ${puertas} Puertas -precio: ${precio} - Transmision: ${transmision} - Color: ${color}
        
        `;
        // insertsar en el HTML
...
function llenarSelect (){
    ...
    for ( let i = max; i > min; i--){
        ...
        year.appendChild(opcion); // Agrega opciones de cambio a select    
    }
}
